...
public class NabtaBackendApplication {
	...
	public CommandLineRunner demo(DiseaseDao diseaseDao, ImageDao imageDao) {
		return (args) -> {
			...
			potato_early_blight_fr.setCycleImage("https://firebasestorage.googleapis.com/v0/b/nabta-38d6a.appspot.com/o/disease%2Fimage%2F1623401361266?alt=media&token=4148d006-43bb-4fc4-8dd0-dc39521e5e8d");
			potato_early_blight_fr.setNomClasse("Potato Early Blight");
			...
			tomato_early_blight_fr.setNomClasse("Tomato Early Blight");
			...
			tomato_late_blight_fr.setNomClasse("Tomato Late Blight");
			...
			potato_early_blight_en.setCycleImage("https://firebasestorage.googleapis.com/v0/b/nabta-38d6a.appspot.com/o/disease%2Fimage%2F1623401361266?alt=media&token=4148d006-43bb-4fc4-8dd0-dc39521e5e8d");
			...
			potato_early_blight_en.setCycleImage("https://firebasestorage.googleapis.com/v0/b/nabta-38d6a.appspot.com/o/disease%2Fimage%2F1623401361272?alt=media&token=aacb746c-3947-4710-8f4e-65818c04d82e");
			...
			tomato_early_blight_en.setNomClasse("Tomato Early Blight");
			...
			tomato_late_blight_en.setNomClasse("Tomato Late Blight");
